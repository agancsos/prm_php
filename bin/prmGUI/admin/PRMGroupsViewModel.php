<?php
    ...
    class PRMGroupsViewModel extends PRMActionViewModel {
        ...
        public function __construct($parent) {
			...
			$this->sources = $this->objectService->getTypeItems("GROUP");
        ...
        public function getName() { return "Groups"; }
        public function getTitle() { return "Groups"; }
				...
				if($i == 0) {
					...
					foreach($allUsers as $user) {
						...
						if($this->currentSource != NULL) {
							...
							if(PRMSecurityService::getInstance()->isUserInGroup($user, $this->currentSource)) {
								print("Remove");
							}
							else {
								print("Add");
							...
							if(isset($_POST['add-remove-user'])) {
								if($_POST['add-remove-user'] == "Add") {
									PRMSecurityService::getInstance()->addGroupMember($this->currentSource, $_POST['id']);
								}
								else if($_POST['add-remove-user'] == "Remove") {
									PRMSecurityService::getInstance()->removeGroupMember($this->currentSource, $_POST['id']);
								}
